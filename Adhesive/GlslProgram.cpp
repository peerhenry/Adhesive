...
using peg_glsl::GLSLProgramException;
...
namespace GLSLShaderInfo {
  ...
  {
    { ".vs", peg_glsl::VERTEX },
    { ".vert", peg_glsl::VERTEX },
    { ".gs", peg_glsl::GEOMETRY },
    { ".geom", peg_glsl::GEOMETRY },
    { ".tcs", peg_glsl::TESS_CONTROL },
    { ".tes", peg_glsl::TESS_EVALUATION },
    { ".fs", peg_glsl::FRAGMENT },
    { ".frag", peg_glsl::FRAGMENT },
    { ".cs", peg_glsl::COMPUTE }
  };
}
...
throw(GLSLProgramException) {
  ...
  peg_glsl::GlslShaderType type = peg_glsl::VERTEX;
