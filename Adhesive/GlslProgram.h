...
#include <stdexcept>
#include "pegglsl/IGlslProgram.h";
using peg_glsl::IGlslProgram;
using peg_glsl::GlslShaderType;
...
public:
  ...
  void   compileShader(const char * fileName, GlslShaderType type) throw (GLSLProgramException);
